    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          sure you have a good experience using our online thrift marketplace.
        </p>
        <p>
          As with any online platform, there are certain terms and conditions
          that apply. By placing an order or using Angels Attic, you agree to
          the terms below along with other terms on our website, such as our
          return policy, privacy policy, and terms of use. Please review
        ...
        <p>
          ...
          will facilitate the transaction subject to these Terms. Unless
          expressly agreed to or set forth in writing by Angels Attic, any term
          or condition in any order or correspondence that is inconsistent with
          these Terms shall be inapplicable and of no force and effect
          whatsoever.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Angels Attic’s acceptance. This means Angels
          Attic may, for any reason, refuse to accept or may cancel or limit any
          order or order quantity, whether or not the order has been confirmed.
          Your receipt of an order confirmation does not mean our acceptance of
          your order, nor is it a confirmation of our offer to sell. We are
          simply confirming that we received your order. If we cancel an order
          after you have already been charged, Angels Attic will refund you the
          charged amount.
        </p>
        ...
        <p>
          ...
          and it is accepted by Angels Attic or the respective seller. Prices
          for products displayed on this website exclude shipping charges, which
          are calculated and displayed depending on the shipping option for the
          item you select when you finalize your purchase. Angels Attic reserves
          the right to amend pricing for any pricing errors displayed due to
          human error, system malfunction, or any other reason. Where a pricing
          error is identified after you have submitted an online order, Angels
          Attic will notify you of the error in pricing as soon as reasonably
          practicable, and you may elect to not proceed with the purchase of any
          product(s) where the price has been corrected.
        </p>
        <h2>Special Offers</h2>
        <p>
          From time to time, we may offer special promotions for some or all of
          our products or categories, including discounts, limited-time offers,
          or free shipping. These offers may be for a limited time only, and
          Angels Attic reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder may include
          applicable taxes where required. Customers shall pay, and reimburse
          Angels Attic if it pays, any taxes, except for those based on Angels
          Attic’s income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Angels Attic for when the
          ...
          are beyond our control. Angels Attic cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Angels Attic, the
          customer may not cancel such accepted order without Angels Attic’s
          consent. Customers may return eligible products for a refund of the
          purchase price (not including initial shipping charges) plus any
          applicable tax, subject to our return policy. Customers shall arrange
          for and pay return shipping expenses unless otherwise stated. The
          product(s) must be returned within the timeframe indicated in the
          applicable policy.
        </p>
        <h2>Warranty</h2>
        <p>
        ...
        <p>
          Products sold on our website are primarily intended for end-user
          customers. We reserve the right to refuse or cancel any order if we
          suspect misuse, fraud, or violation of these Terms.
        </p>
        ...
        <p>
          ...
          indemnify and hold Angels Attic harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Angels Attic</p>
        <p style={{ fontWeight: "500" }}>123 Thrift Lane, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@angelsattic.com</span>
        </p>
      </div>
    </div>
  );
